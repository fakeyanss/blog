...
在今天之前，我都在刻意地使用半角符号，因为在中文输入的时候，想输入一个 <kbd>`</kbd> 或者 <kbd>/</kbd> 字符，是很麻烦的事情，来回切换输入法让我想立刻停下打字，关掉电脑。

但是这篇文章确实说的很好，而且按照文档的排版，表现形式看起来非常好，我想记在这里，帮助我刻意练习一下这样的排版方式。

下面是原文内容，[出自 mzlogin](https://github.com/mzlogin/chinese-copywriting-guidelines)。
